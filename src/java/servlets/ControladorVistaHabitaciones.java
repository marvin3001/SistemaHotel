 ...
 * @author Sony
 */
public class ControladorVistaHabitaciones extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (pagina.equals("/MostrarVistaHabitaciones.do")) {
                ...
                despachador = request.getRequestDispatcher("listadohabi.jsp");
            }
